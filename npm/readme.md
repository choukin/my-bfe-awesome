...
npm --registry http://npm.qingsongchou.net/ install package-name
2. 全局配置
...
业务线自用模块前缀增加对应域：
基础：@qsc-jc/package-name
保险：@qsc-bx/package-name
微爱：@qsc-wa/package-name
健康：@qsc-jk/package-name
会员：@qsc-hy/package-name
通用模块使用公用域：
公用：@qsc/package-name
